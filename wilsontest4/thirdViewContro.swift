...
class thirdViewController:UIViewController,UIPageViewControllerDataSource{
    ...
    override func viewDidLoad() {
        ...
        //設定開始的頁面
        let startPage = self.viewControllerAtIndex(index:0) as PageViewController
    ...
    func viewControllerAtIndex(index:Int) -> PageViewController{
        ...
        let vc =
            self.storyboard?.instantiateViewController(
                withIdentifier: "maincontentviewcontrol") as! PageViewController
